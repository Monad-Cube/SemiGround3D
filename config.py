...
class Config():
    def __init__(self) -> None:
        ...
        self.parser.add_argument("--object_id", type=str, help="object id", default="")
        self.parser.add_argument("--ann_id", type=str, help="ann id", default="")
    ...
    def set_paths_cfg(self, CONF):
        ...
        CONF.SCANNETV2_LABELED_TRAIN = os.path.join(CONF.PATH.SCANNET_META, "scannetv2_train_0.1.txt")
