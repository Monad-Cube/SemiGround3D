...
class PredictHead(nn.Module):
    ...
    def forward(self, features, base_xyz, end_points, prefix='', lang_feat=None, lang_mask=None, 
        ...
        """
        # feature -> relu(bn1(conv1)) -> relu(bn2(conv2))
        ...
        # ref, false when getting proposal
        if self.use_ref_branch:
        ...
        # classification with language, false when getting proposal
        if self.use_cls_branch:
        ...
        if self.use_ref_branch:
            return center, pred_size, fusion_feat
        else:
