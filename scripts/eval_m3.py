...
def eval_ref(args):
    ...
    # dataloader
    _, dataloader = get_dataloader(args, m3drefer, scene_list, "val", DC)
        ...
        for seed in seeds:
            ...
            for data in tqdm(dataloader):
                ...
                for i in range(ids.shape[0]):
                    idx = ids[i]
                    scene_id = m3drefer[idx]["scene_id"]
                    object_id = m3drefer[idx]["object_id"]
                    ann_id = m3drefer[idx]["ann_id"]
    ...
    prediction_output_root_path = "/workspace/yf/projects/Semi-SPS/m3predictions/20%_m3_soft" 
